...
public class SungJukV5 {
    public static void main(String[] args) {
        ...
        // Cat c = new Cat()
        // Animal cd = new Cat()   (!!)  cd 변수하나로 c는 cat d는 dog 양쪽둘다  객체 받을수있음
        // cd = new Dog()         (!!)   //cat dog는 부모가 Animal로 같은 상속받은것이기 때문에 가능한거다

        // 인터페이스를 이용한 구현한 클래스 객체 생성하기
        // 인터페이스 객체명 = new 클래스명 // <- 왼쪽 부모클래스 오른쪽 자식 클래스
        //SungJukV5ServiceImpl sjsrv = new SungJukV5ServiceImpl()(); 밑에방식이 더 좋음
...
// 보통 인터페이스의 명명법은 이름끝에 Serivce를 추가함
...
class SungJukV5ServiceImpl implements  SungJukV5Service{
    ...
    public void computeSungJuk(SungJukVO sj) {
        ...
        switch( (int)sj.getAvg() / 10) {
            ...
            case 6: sj.setGrd('양');break; default:
                    sj.setGrd('가');break;
        }
    }
