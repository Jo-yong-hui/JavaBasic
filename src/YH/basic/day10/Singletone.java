...
public class Singletone {
    ...
    public static void main(String[] args){
        ...
        // 이 경우에는 so1과 so2의 변수 값은 서로 다르다 - 인스턴스 변수
...
class ServiceTwo{
    ...
    private ServiceTwo() { } //생성자없이 만든 것 //private

    //외부에서 getInstance를 사용하기 위해 static을 붙여준다.
    //유일한 생성자인 객체인 인스턴스라는 메서드를 사용위해 get을 붙여서 만든다.
