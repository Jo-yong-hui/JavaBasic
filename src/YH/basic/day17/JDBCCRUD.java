...
public class JDBCCRUD {
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        String amz = "bigdata.cwj3cdfzt1so.ap-northeast-2.rds.amazonaws.com";
        ...
        String books = "create table books (bookid int," +
                ...
                " price int  )";
        // 밑으로 한줄 내려서 쓸때는 "   " 여기 사이에 양쪽에 빈칸을 띄어준다
        String newbooksql = " insert into books " +
                " values (99999, 'hello, java','oracle',10000) ";

        //동적 sql문 값을 지정해줌 %d인지 %s인지
        String newbooksql2 = " insert into books " +
                " values (%d, '%s','%s', %d ) ";

        // JDBC 작업시작
        //  "org.mariadb.jdbc.Driver"; 드라이버 클래스를
        //  동적으로 객체화(객체를 만들어서) 구현한것
        ...
        try (
            ...
            //boolean(자료형)함수는 주어진 논리식을 판단하여 true/false 반환
