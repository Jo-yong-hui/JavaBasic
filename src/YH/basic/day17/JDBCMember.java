...
public class JDBCMember {
    public static void main(String[] args) {
        ...
        // 테이블명 : NMember (playground)에 만들기
        // 테이블 컬럼 구성 : 아이디userid, 비밀번호passwd, 이름name,
        // 생년월일(birth), 성별(gender), 본인 확인 이메일email, 휴대전화hp,
        //
        // 자동입력 컬럼 : 회원번호mbno, 가입일regdate
        ...
        //       0, 'abc123@987xyz.com', '010-000-000');
        ...
        try( Connection conn = jdbc.openConn();
            ...
            while(rs.next()){
                ...
                //여기서 substring한거는 회원가입 후 날짜만 조회하기 위한것이다.
                        sb.append(result);
            }
