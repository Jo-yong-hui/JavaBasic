...
public class SungJukServiceV4Impl implements SungJukServiceV4 {
    ...
    public void showSungJuk() {
        //String fmt = "성적(문자열): %s, 이름:%s, 국어:%d  영어:%d  수학:%d, 등록일 \n";
        String fmt = " %s, %s, %d, %d  %d, %s\n";
        // SungJukVO에  protected String sjno을 string으로 해놔서 %s
    ...
    public void removeSungJuk() {
        ...
        try {
            ...
            if( cnt > 0) System.out.println("성적 데이터가 삭제 완료!");
