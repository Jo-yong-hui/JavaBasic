...
public class EX03 {
    public static void main(String[] args) {
        ...
        letter[1] = 'b';
        letter[2] = 'c';
        // letter 배열의 각 요소에 a,b,c문자를 저장함

        //char[] letter ={'a','b','c'};
        //위 5줄 letter코드를 한 줄로 작성하는 방법
...
//        System.out.print(num1[9]);
        ...
        for (int i = 1; i < num3.length; ++i) {
            //num3[i] = i * i; //num3[i] = (i+1)*(i+1); 같은거
            num3[i] = (int) Math.pow((i + 1), 2);  //pow(밀수, 지수), (int)한것은 double을 int로 변환한거다
            System.out.print(num3[i] + ", ");
        }
        System.out.print(""); //줄바꿈 표시
        ...
        // 출력 : 99 8 77 6 55 4 33 2 11 0 //위에 숫자 뒤집힌거
