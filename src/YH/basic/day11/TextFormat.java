...
public class TextFormat {
    ...
    public static void main(String[] args) {
        ...
        String fmt = " 이름:{0} , 국어:{1}, 영어:{2}, 수학:{3} "; //{} 인덱스 순서바꾸면 결과도 바꿔서나옴
        String result = MessageFormat.format(
                fmt, name, kor, eng, mat);
        System.out.println(result);
        //변수의 바인딩을 임의로 설정가능
        
        Object[] sj = {"지현",78,65,12,580,53.2,'우'};
        result = MessageFormat.format(fmt, sj); 
        System.out.println(result);
        // 변수를 배열로 정의하면 바인딩을
        // 수월하게 할 수 있음
        //sj는 " 이름:{0} , 국어:{1}, 영어:{2}, 수학:{3} "; 값을 지정해서 출력
   
        // DecimalFormat
        // 정수, 실수를 포함한 다양한 종류의수를
