...
public class Book2 {
    //book2클래스
        ...
        public Book2(String bkname, String writer, String trlator, String publisher, String pubdate,
                     int bkprice, double discount, int saleprice, int point) {
            this.bkname = bkname;
            this.writer = writer;
    ...
    public String getTrlator() { return trlator; }

    public void setTrlator(String trlator) { this.trlator = trlator; }
